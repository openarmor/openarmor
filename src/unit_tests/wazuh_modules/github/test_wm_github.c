...
static int teardown_conf(void **state) {
    ...
    test_mode = 0;
    expect_string(__wrap__mtinfo, tag, "openarmor-modulesd:github");
...
void test_github_main_fail_StartMQ(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "openarmor-modulesd:github");
...
void test_github_scan_failure_action_3(void **state) {
    ...
    expect_string(__wrap__mtwarn, tag, "openarmor-modulesd:github");
...
void test_github_execute_scan(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "openarmor-modulesd:github");
...
void test_github_execute_scan_status_code_200_null(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "openarmor-modulesd:github");
