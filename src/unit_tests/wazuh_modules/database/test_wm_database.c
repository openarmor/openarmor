...
void test_wm_sync_group_file_error_agent_id(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "openarmor-modulesd:database");
...
void test_sync_keys_with_wdb_insert(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "openarmor-modulesd:database");
...
void test_sync_keys_with_wdb_insert_delete(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "openarmor-modulesd:database");
    expect_string(__wrap__mtdebug1, formatted_msg, "Could not remove the openarmor-db DB of the agent 1.");
...
void test_sync_keys_with_wdb_null(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "openarmor-modulesd:database");
