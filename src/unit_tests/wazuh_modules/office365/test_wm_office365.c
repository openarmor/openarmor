...
static int teardown_conf(void **state) {
    ...
    test_mode = 0;
    expect_string(__wrap__mtinfo, tag, "openarmor-modulesd:office365");
...
void test_wm_office365_main_fail_StartMQ(void **state) {
    ...
    expect_string(__wrap__mterror, tag, "openarmor-modulesd:office365");
...
void test_wm_office365_main_enable(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "openarmor-modulesd:office365");
...
void test_wm_office365_scan_failure_action_not_null(void **state) {
    ...
    expect_string(__wrap__mtwarn, tag, "openarmor-modulesd:office365");
...
void test_wm_office365_execute_scan_all(void **state) {
    ...
    expect_string(__wrap__mtdebug2, tag, "openarmor-modulesd:office365");
