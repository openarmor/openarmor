...
brief: These tests will check if the 'openarmor-authd' daemon correctly handles the enrollment requests,
       ...
       The 'openarmor-authd' daemon can automatically add a Wazuh agent to a Wazuh manager and provide
...
def test_ossec_auth_messages(test_configuration, test_metadata, set_wazuh_configuration,
    ...
    '''
    description:
        Checks if when the `openarmor-authd` daemon receives different types of enrollment requests,
