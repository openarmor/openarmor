...
references:
    ...
    - https://documentation.wazuh.com/current/user-manual/capabilities/openarmor-logtest/logtest-configuration.html
...
def test_load_rules_decoders(test_metadata, daemons_handler_module, wait_for_logtest_startup,
    ...
    '''
    description: Check if 'openarmor-logtest' does produce the right decoder/rule matching when processing a log under
