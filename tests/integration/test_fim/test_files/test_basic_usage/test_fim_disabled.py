...
def test_fim_disabled(test_configuration, test_metadata, set_wazuh_configuration, truncate_monitored_files,
    ...
    '''
    description: Check if the 'openarmor-syscheckd' daemon generates FIM events when it is disabled
    ...
    assertions:
        - Verify that when the 'openarmor-syscheckd' daemon is disabled, no FIM events are generated.
